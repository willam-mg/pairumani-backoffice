...
@section('header')
    ...
    <h3 class="m-0 text-dark">Galeria evento: {{ $evento->nombre }}</h3>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb" style="background-color: inherit">
						...
						<li class="breadcrumb-item"><a href="{{ route('eventos_show',$evento->id) }}">Evento {{ $evento->nombre }}</a></li>
		...
		<div class="container-fluid">
			<div class="row">
                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('eventos_galeria',$evento->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
