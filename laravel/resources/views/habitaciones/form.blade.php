...
<div class="card">
    ...
    <div class="card-body ">
        ...
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="form-group bmd-form-group {{ $errors->has('precio_promocion') ? 'has-danger' : '' }}">
                <label for="precio_promocion" class="bmd-label-floating">Precio Promocion</label>
                <input type="number" min="1" name="precio_promocion" value="{{ old('precio_promocion', $habitacion->precio_promocion) }}" class="form-control" autofocus>
                @if ($errors->has('precio_promocion'))
                    <span id="precio_promocion-error" for="precio_promocion" class="error">{{ $errors->first('precio_promocion') }}</span>
                @endif
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
