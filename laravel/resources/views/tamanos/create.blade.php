            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb" style="background-color: inherit">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('tamanos_index',[$categoria->id,$producto->id]) }}">tamano</a></li>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto">
					<form method="POST" action="{{ route('tamanos_create',[$categoria->id,$producto->id]) }}">
