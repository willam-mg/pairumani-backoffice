                    ...
                    <div class="card-body">
                        <div class="row" style="font-size: 20px">
                            ...
                            <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">                    
                                ...
                                <b>Precio Promoción:</b> {{ $reserva->habitacion->precio_promocion }} <br>
                            </div>
                            <div class="col-lg-7 col-sm-7 col-md-7 col-xs-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                <div class="form-group">
                                    <a class="btn btn-success" href="{{ route('acompanantes_create',[$tipo,$categoria->id,$habitacion->id,$reserva->id]) }}" style="margin-top: 25px">Nuevo Acompañante</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
