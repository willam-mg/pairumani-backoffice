        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group text-right">
                    <a class="btn btn-default" href="{{ route('cafeteria_tamanos_index',[$categoria->id,$producto->id]) }}" title="Cerrar"><i class="material-icons">clear</i> Cerrar</a>
                    @if(kvfj(Auth::user()->rol->permisos,'cafeteria_tamanos_edit'))
                        <a class="btn btn-warning" href="{{ route('cafeteria_tamanos_edit',[$categoria->id,$producto->id,$tamano->id]) }}" title="Modificar"><i class="material-icons">edit</i> Modificar</a>
                    @endif                    
                </div>
            </div>
        </div>
