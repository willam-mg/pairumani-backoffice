...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group bmd-form-group {{ $errors->has('nombre') ? 'has-danger' : '' }}">
            ...
            <input type="text" name="nombre" value="{{ old('nombre', $frigobar->nombre) }}" class="form-control" autofocus>
        ...
        <div class="form-group bmd-form-group {{ $errors->has('precio') ? 'has-danger' : '' }}">
            ...
            <input type="number" min="1" name="precio" value="{{ old('precio', $frigobar->precio) }}" class="form-control">
