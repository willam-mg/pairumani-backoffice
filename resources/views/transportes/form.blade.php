...
<div class="card">
    ...
    <div class="card-body ">
        <div class="form-group bmd-form-group {{ $errors->has('nombre') ? 'has-danger' : '' }}">
            ...
            <input type="text" name="nombre" value="{{ old('nombre',$transporte->nombre) }}" class="form-control">
        ...
        <div class="form-group bmd-form-group {{ $errors->has('descripcion') ? 'has-danger' : '' }}">
            ...
            <textarea name="descripcion" id="editor" class="form-control" cols="30" rows="10">{{ old('descripcion', $transporte->descripcion) }}</textarea>
        ...
        <div class="form-group bmd-form-group {{ $errors->has('precio') ? 'has-danger' : '' }}">
            ...
            <input type="number" min="1" name="precio" value="{{ old('precio',$transporte->precio) }}" class="form-control">
        ...
        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
            ...
            <div class="fileinput-new thumbnail">
                @if (($transporte->foto)!="")
                    <img src="{{ $transporte->fotourl }}" height="300px" width="300px">
                @else
            ...
            <div>
                <span class="btn btn-rose btn-round btn-file">
                    ...
                    <input type="file" name="foto" value="{{ old('foto',$transporte->foto) }}">
                </span>
    ...
    <div class="card-footer text-right">
        <div class="form-group">
            ...
            <a href="{{ route('transportes_index') }}" class="btn btn-danger">
