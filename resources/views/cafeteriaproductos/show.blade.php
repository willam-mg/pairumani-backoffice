        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group text-right">
                    <a class="btn btn-default" href="{{ route('cafeteria_productos_index',$categoria->id) }}" title="Cerrar"><i class="material-icons">clear</i> Cerrar</a>
                    @if(kvfj(Auth::user()->rol->permisos,'cafeteria_productos_edit'))
                        <a class="btn btn-warning" href="{{ route('cafeteria_productos_edit',[$categoria->id,$producto->id]) }}" title="Modificar"><i class="material-icons">edit</i> Modificar</a>
                    @endif                   
                </div>
            </div>
        </div>
