...
@section('header')
    ...
    <h3 class="m-0 text-dark">Galeria Producto: {{ $producto->nombre }}</h3>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb" style="background-color: inherit">
                        ...
                        <li class="breadcrumb-item active">Galeria Producto</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
		...
		<div class="container-fluid">
			<div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('cafeteria_productos_galeria',[$categoria->id,$producto->id]) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <a href="{{ route('cafeteria_productos_index',$categoria->id) }}" class="btn btn-danger">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    <div class="row">
                        @foreach ($producto->fotos as $foto)
                            <form method="POST" action="{{ route('cafeteria_productos_galeria_destroy',[$categoria->id,$producto->id,$foto->id]) }}">
                                @method('DELETE') @csrf
                                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                                    @if(kvfj(Auth::user()->rol->permisos,'cafeteria_productos_galeria_destroy'))
