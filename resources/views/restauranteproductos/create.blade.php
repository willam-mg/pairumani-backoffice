...
@section('header')
    ...
    <h3 class="m-0 text-dark">Nuevo Producto</h3>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-centered ml-auto mr-auto">
					<form method="POST" action="{{ route('productos_create',$categoria->id) }}" enctype="multipart/form-data">
						@include('restauranteproductos.form')
					</form>
				</div>
			</div>
    	</div>
