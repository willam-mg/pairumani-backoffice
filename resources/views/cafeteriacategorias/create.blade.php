...
@section('header')
    ...
    <h3 class="m-0 text-dark">Nuevo Cafeteria Categoria</h3>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb" style="background-color: inherit">
                        ...
                        <li class="breadcrumb-item active">Nuevo Cafeteria Categoria</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-centered ml-auto mr-auto">
					<form method="POST" action="{{ route('cafeteriacategorias_create') }}" enctype="multipart/form-data">
