            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb" style="background-color: inherit">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('cafeteria_opciones_index',[$categoria->id,$producto->id]) }}">Opciones</a></li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group text-right">
                    <a class="btn btn-default" href="{{ route('cafeteria_opciones_index',[$categoria->id,$producto->id]) }}" title="Cerrar"><i class="material-icons">clear</i> Cerrar</a>
                    @if(kvfj(Auth::user()->rol->permisos,'cafeteria_opciones_edit'))
                        <a class="btn btn-warning" href="{{ route('cafeteria_opciones_edit',[$categoria->id,$producto->id,$opcion->id]) }}" title="Modificar"><i class="material-icons">edit</i> Modificar</a>
                    @endif                   
                </div>
            </div>
        </div>
