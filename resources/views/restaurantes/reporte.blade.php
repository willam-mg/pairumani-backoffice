                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-uppercase" colspan="3">
                                Cliente: {{ $restaurante->hospedaje ? $restaurante->hospedaje->cliente->nombrecompleto : $restaurante->cliente->nombrecompleto }} <br>
                                Email: {{ $restaurante->hospedaje ? $restaurante->hospedaje->cliente->email : $restaurante->cliente->email }}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td class="text-uppercase" style="font-size: 12px">
                                Total venta: {{ env('MONEYLOCAL') }} {{ number_format($restaurante->total,2) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
