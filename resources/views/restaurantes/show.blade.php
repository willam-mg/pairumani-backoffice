...
@section('contenido')
    <div class="row">
        <div class="col-md-6 ml-auto mr-auto">
            <div class="card">
                <div class="card-body">
                    <h3 class="title">Reserva {{ $restaurante->id }}</h3>
                    <hr>
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <b> Fecha: </b>
                            {{ $restaurante->fecha.' '.$restaurante->hora }}
                        </div>
                    </div>
                    <hr>                
                    <div class="row">
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $restaurante->hospedaje ? $restaurante->hospedaje->cliente->celular : $restaurante->cliente->celular }}</td>
                                            <td>{{ $restaurante->hospedaje ? $restaurante->hospedaje->cliente->email : $restaurante->cliente->email }}</td>
                                        </tr>                        
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($restaurante->detalles as $detalle)
                                            <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>
                                                <h4 id="total">
                                                    <b>
                                                        Total: {{ env('MONEYLOCAL') }} {{ number_format($restaurante->total,2) }}
                                                    </b>
                                                </h4>
                                            </th>
                                        </tr>
                            ...
                            <div class="form-group text-right">
                                <a href="{{ route('restaurantes_index') }}" class="btn btn-default">
